...
class Hip(rModule.RigModule):
    ...
    def control_rig(self):
        self.hip_01 = rCtrl.Control(
            parent=self.control_grp,
            shape=self.cog_shape,
            side=None,
            suffix="CTRL",
            name="COG_M",
            axis="y",
            ...
            rotate=self.guide_list[0] if self.ctrl_rotate else (0, 0, 0),
            ctrl_scale=self.ctrl_scale,
        )
        self.hip_01.tag_as_controller()
        if self.generate_waist:
            self.hip_02 = rCtrl.Control(
                parent=self.hip_01.ctrl,
                shape=self.waist_shape,
                side=None,
                suffix="CTRL",
                name="waist_M",
                axis="y",
