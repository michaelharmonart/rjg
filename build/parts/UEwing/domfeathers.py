...
def get_closest_split_joint(transform: str, joint: str, side: str,) -> str:
    split_joints = [f'arm_{side}_01_JNT', f'arm_{side}_02_JNT',f'arm_{side}_03_JNT',f'arm_{side}_04_JNT', f'arm_{side}_05_JNT', f'arm_{side}_07_JNT', f'arm_{side}_08_JNT', f'arm_{side}_09_JNT',]
...
def build_feathers(wing: "UEwing", keep_spacing: bool = True):
    ...
    for index, (root_guide, mid_guide, tip_guide) in enumerate(
        ...
        orient_driver = get_closest_split_joint(root_pin.pin, orient_driver_base, side)
        ...
        for guide in [root_pin.pin] + mid_guides + [tip_guide]:
            ...
            if joint_parent is None:
                joint_parent = get_closest_split_joint(pin, joint_parent_segment, side)
