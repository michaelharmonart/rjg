...
class RigBuildUI(QtWidgets.QDialog):
    def __init__(self, parent=get_main_qt_window()):
        ...
        self.default_dict = {
            ...
            "Gretchen" : {
                ...
                "sp" : f"{groups}/bobo/character/Rigs/Gretchen/Weights/Gretchen_Weights_22.json", 
                "pp" : f"{groups}/bobo/character/Rigs/Gretchen/Poses/GretchenPose21.pose",
            ...
            "Luciana" : {
                ...
                "pp" : f"{groups}/bobo/character/Rigs/Luciana/Poses/Luciana_Poses.pose", #Luciana_Poses.pose
            ...
            "Domingo" : {
                ...
                "pp" : f"{groups}/bobo/character/Rigs/Domingo/Poses/Domingo_Poses_Full.pose",
            ...
            "Basemesh" : {
                ...
                "cp" : f"{groups}/bobo/character/Rigs/Basemesh/Controls/Basemesh_control_curves.json",
            ...
            "CrowdB" : {
                "mp" : f"{groups}/bobo/character/Rigs/CrowdB/CrowdB_Model.mb",
                "gp" : f"{groups}/bobo/character/Rigs/CrowdB/CrowdB_Guides.mb",
                "ep" : f"{groups}/bobo/character/Rigs/CrowdB/CrowdB_Extras.mb",
                "cp" : f"{groups}/bobo/character/Rigs/Basemesh/Controls/Basemesh_control_curves.json", 
                "sp" : f"{groups}/bobo/character/Rigs/Basemesh/SkinFiles/Basemesh_Skin.json",  
                "pp" : None,
                "im" : None, #f"{groups}/Bobo/character/Rigs/Rig_Icon/Bee.jpg",
    ...
    def create_widgets(self):
        ...
        self.char_options.addItems([ 'Bobo', 'Gretchen', 'Luciana', 'Domingo', 'Basemesh', 'CrowdB', 'Susaka', 'Drummer', 'Fisherman', 'Rayden', 'Robin', 'DungeonMonster', 'Skeleton', 'Jett', 'Blitz', 'Sharkguy', 'RedPanda'])
